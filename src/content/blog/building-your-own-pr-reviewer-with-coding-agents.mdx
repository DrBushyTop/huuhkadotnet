...
This post is about the architecture. I'll use [GitHub Copilot SDK](https://github.com/github/copilot-sdk?ref=huuhka.net) in the examples for the LLM side, because it maps cleanly to this kind of coding-agent workflow. The overall pattern works just as well with other harnesses or plain CLIs.
