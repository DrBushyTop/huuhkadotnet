...
export async function GET() {
  ...
  const pages=[{path:'/',updated:undefined},{path:'/author/pasi/',updated:undefined},{path:'/privacy/',updated:undefined},...tags.map(tag=>({path:`/tag/${tag.slug}/`,updated:undefined})),...entries.map(({data})=>({path:`/${data.slug}/`,updated:data.updatedAt}))];
