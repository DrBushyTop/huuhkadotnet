...
import { lightCodeTheme } from './scripts/code-themes.mjs';
...
export default defineConfig({
  ...
  redirects,
  markdown: { shikiConfig:{themes:{light:lightCodeTheme,dark:'catppuccin-macchiato'}, defaultColor:false, langAlias:{'YAML':'yaml',pwsh:'powershell'}}, processor:unified({rehypePlugins:[rehypeContent],smartypants:false}) },
